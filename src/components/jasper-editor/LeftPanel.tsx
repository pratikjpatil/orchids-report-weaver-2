...
const VirtualizedRowList = memo(({
  ...
  if (rows.length === 0) {
    return (
      <Box sx={{ p: 2, textAlign: "center", color: "text.secondary", bgcolor: "background.paper", borderRadius: 1, mt: 1 }}>
          ...
          if (index === rows.length) {
            return (
              <Box
                ...
                onDragOver={(e) => onDragOver(e, rows.length)}
                onDrop={onDragEnd}
              >
                <Box
                  sx={{
          ...
          return (
            ...
            >
              <RowItem
                ...
                onDragEnd={onDragEnd}
                onInsertClick={(e) => onInsertClick(e, index + 1)}
                onRemove={() => onRemoveRow(row.id, index)}
              />
            </Box>
          );
        })}
